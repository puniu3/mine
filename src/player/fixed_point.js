...
import {
    ...
    ACCELERATOR_ACCELERATION_AMOUNT, LOW_FRICTION_EXIT_SPEED,
...
// Low friction mode exit speed in FP
export const LOW_FRICTION_EXIT_SPEED_FP = toFP(LOW_FRICTION_EXIT_SPEED);
