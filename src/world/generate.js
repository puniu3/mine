...
import { generateStructures, generateHiddenFeatures, generateSurfacePonds, generateWaterfalls, generateHydrothermalVents } from './features.js';
...
export function generate(world) {
    ...
    generateHydrothermalVents(world, heights, biomeByColumn);
